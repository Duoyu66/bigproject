...
IF(AND(LEN("1234")<>0,"1234"<>"/"),IF("1"*0.8865),"/")
IF(AND(LEN({空白试验消耗硝酸汞体积试样1})<>0,{空白试验消耗硝酸汞体积试样1}<>"/",LEN({滴定时消耗硝酸汞体积试样1})<>0,{滴定时消耗硝酸汞体积试样1}<>"/"),IF(OR({试验方法}="/",{试验方法}="代用法",LEN({试验方法})=0),{每mL硝酸汞相当于氯质量试样1}*({滴定时消耗硝酸汞体积试样1}-{空白试验消耗硝酸汞体积试样1})*0.1/{试样质量I试样1},({空白试验消耗硝酸汞体积试样1}-{滴定时消耗硝酸汞体积试样1})/{空白试验消耗硝酸汞体积试样1}/{试样质量I试样1}*0.8865),"/")