    ...
    <vab-query-form>
      <template>
        <el-tabs
          v-model="activeName"
        >
        <el-button type="primary" style="margin-bottom: 10px;">保存分配</el-button>
...
export default {
  ...
  methods: {
    ...
    async fetchData() {
      ...
      this.list3 = [
        { doorName: '王小军', doorDate: '2021-1-19 09:00:00', doorOut: '入' },
        { doorName: '王大军', doorDate: '2021-1-18 09:00:00', doorOut: '出' },
        { doorName: '薛腾飞', doorDate: '2021-1-17 09:00:00', doorOut: '入' },
        { doorName: '马增来', doorDate: '2021-1-16 09:00:00', doorOut: '出' },
      ]
      this.list4 = [
        {
