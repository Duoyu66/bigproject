<template>
	<div class="draftPageHigh">
		<el-table ref="branchInstitutions" v-loading="listLoading" :data="tablelist" border
			...
			<el-table-column show-overflow-tooltip label="所属部门" prop="org_name" width="120px"></el-table-column>
			<el-table-column show-overflow-tooltip label="出勤人" prop="person_name" width="90px"></el-table-column>
      <el-table-column show-overflow-tooltip label="年月" prop="duty_month" width="90px"></el-table-column>
			<el-table-column show-overflow-tooltip label="出勤时间段" prop="duty_day" ></el-table-column>
      <el-table-column show-overflow-tooltip label="出勤天数" prop="day_number" width="120px"></el-table-column>
      <el-table-column show-overflow-tooltip label="差旅费(元)" prop="need_pay" width="120px"></el-table-column>
	...
	export default {
        ...
        doc.generate("demo.docx");
          ...
          case 3:
			...
			async fetchData1() {
				let that = this
        let sData = '[Q]875{'+this.current_org_id+'%$`'+this.queryForm.person_name+'$`'
        ...
        res.data.forEach((item, index) => {
          item.day_number=item.duty_day.split(',').length
          item.need_pay = Number(item.day_number)*100
        })
