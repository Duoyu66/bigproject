<template>
	<div class="draftPageHigh">
      ...
      <el-table-column show-overflow-tooltip label="花销项目" prop="duty_month" width="90"></el-table-column>
      <el-table-column show-overflow-tooltip label="日期" prop="salaryexpense" min-width="120"></el-table-column>
			<el-table-column show-overflow-tooltip label="花费" prop="consignexpense" min-width="120" ></el-table-column>
      <el-table-column show-overflow-tooltip label="详细事由" prop="travelexpensessum" min-width="120"></el-table-column>
      <el-table-column show-overflow-tooltip label="是否请示" prop="oldexpense" min-width="120" ></el-table-column>
      <el-table-column show-overflow-tooltip label="有无发票" prop="expenseaccount" min-width="120" ></el-table-column>
