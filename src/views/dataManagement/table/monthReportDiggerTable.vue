<template>
	<div class="draftPageHigh">
      ...
      <el-table-column show-overflow-tooltip label="特殊实验" prop="salaryexpense" min-width="120"></el-table-column>
			<el-table-column show-overflow-tooltip label="常规实验" prop="consignexpense" min-width="120" ></el-table-column>
