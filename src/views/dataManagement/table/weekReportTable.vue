<template>
	<div class="draftPageHigh">
		<el-table ref="branchInstitutions" v-loading="listLoading" :data="tablelist" border
			...
			<el-table-column show-overflow-tooltip label="所属部门" prop="org_name" width="90px"></el-table-column>
			<el-table-column show-overflow-tooltip label="提交人" prop="person_name" width="90px"></el-table-column>
      <el-table-column show-overflow-tooltip label="周报周数" prop="week_number" width="120px"></el-table-column>
			<el-table-column show-overflow-tooltip label="周报标题" prop="report_title" width="170px"></el-table-column>
			<el-table-column show-overflow-tooltip label="周报内容" prop="report_content" min-width="300px"></el-table-column>
      <el-table-column show-overflow-tooltip label="提交日期" prop="submit_time" width="120px"></el-table-column>
	...
	export default {
        ...
        doc.generate("demo.docx");
          ...
          case 3:
			...
			async fetchData1() {
				let that = this
        let sData = '[Q]858{'+this.current_org_id+'$`'+this.queryForm.week_number+'$`'+this.queryForm.person_name+'$`'
