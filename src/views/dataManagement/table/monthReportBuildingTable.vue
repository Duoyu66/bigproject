<template>
	<div class="draftPageHigh">
      ...
      <el-table-column show-overflow-tooltip label="委外送检费" prop="salaryexpense" min-width="120"></el-table-column>
			<el-table-column show-overflow-tooltip label="实验验工" prop="consignexpense" min-width="120" ></el-table-column>
