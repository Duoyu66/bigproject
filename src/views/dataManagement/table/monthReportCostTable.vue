<template>
	<div class="draftPageHigh">
      ...
      <el-table-column show-overflow-tooltip label="工资成本" prop="salaryexpense" min-width="120"></el-table-column>
			<el-table-column show-overflow-tooltip label="委外成本" prop="consignexpense" min-width="120" ></el-table-column>
      <el-table-column show-overflow-tooltip label="差旅费" prop="travelexpensessum" min-width="120"></el-table-column>
      <el-table-column show-overflow-tooltip label="设备折旧" prop="oldexpense" min-width="120" ></el-table-column>
      <el-table-column show-overflow-tooltip label="各类报销" prop="expenseaccount" min-width="120" ></el-table-column>
      <el-table-column show-overflow-tooltip label="合计" prop="sumexpense" min-width="120" ></el-table-column>
    ...
    <monthReportCostDetailDialog ref="monthReportCostDetailDialog" :is-up-data.sync="main_dialog">
    </monthReportCostDetailDialog>
	</div>
</template>
...
<script>
  ...
  import monthReportCostDetailDialog from '../components/monthReportCostDetailDialog'
	export default {
		name: 'sealApplyTable',
		components: {
      monthReportCostDetailDialog
        ...
        doc.generate("demo.docx");
          ...
          case 3:
			...
			async fetchData1() {
				let that = this
        let sData = '[Q]878{'+this.current_org_id+'%$`'
