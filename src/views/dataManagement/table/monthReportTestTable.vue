<template>
	<div class="draftPageHigh">
      ...
      <el-table-column show-overflow-tooltip label="桩基" prop="salaryexpense" min-width="120"></el-table-column>
			<el-table-column show-overflow-tooltip label="路基" prop="consignexpense" min-width="120" ></el-table-column>
      <el-table-column show-overflow-tooltip label="隧道" prop="travelexpensessum" min-width="120"></el-table-column>
      <el-table-column show-overflow-tooltip label="复测费" prop="oldexpense" min-width="120" ></el-table-column>
