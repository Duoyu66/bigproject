<template>
	<div class="draftPageHigh">
		<el-table ref="branchInstitutions" v-loading="listLoading" :data="tablelist" border
			...
			<el-table-column show-overflow-tooltip label="项目名称" prop="org_name" min-width="150"></el-table-column>
      <el-table-column show-overflow-tooltip label="日期" prop="cost_date" min-width="120"></el-table-column>
      <el-table-column show-overflow-tooltip label="成本项目" prop="sub_project" min-width="120"></el-table-column>
			<el-table-column show-overflow-tooltip label="金额" prop="amount" min-width="120" ></el-table-column>
      <el-table-column show-overflow-tooltip label="事由" prop="reason" min-width="120"></el-table-column>
      <el-table-column show-overflow-tooltip label="是否请示" prop="isApply" min-width="120" ></el-table-column>
      <el-table-column show-overflow-tooltip label="有无发票" prop="hasReceipt" min-width="120" ></el-table-column>
			...
			<el-table-column show-overflow-tooltip label="操作" width="55px" align="center" fixed="right">
              ...
              <el-dropdown-item icon="el-icon-s-order" divided
  ...
  import {
	...
	export default {
      ...
      project_type: {
        ...
        let sData = '[Q]886{'+this.current_org_id+'%$`'
