<template>
	<div class="draftPageHigh">
      ...
      <el-table-column show-overflow-tooltip label="EH4" prop="salaryexpense" min-width="120"></el-table-column>
			<el-table-column show-overflow-tooltip label="高密度电法" prop="consignexpense" min-width="120" ></el-table-column>
      <el-table-column show-overflow-tooltip label="测井" prop="travelexpensessum" min-width="120"></el-table-column>
      <el-table-column show-overflow-tooltip label="CT" prop="oldexpense" min-width="120" ></el-table-column>
      <el-table-column show-overflow-tooltip label="其他" prop="expenseaccount" min-width="120" ></el-table-column>
