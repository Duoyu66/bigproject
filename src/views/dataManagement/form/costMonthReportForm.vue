...
<!-- 			<el-col :span="span">
      ...
      <el-col :span="span">
      	<el-form-item label="项目名称" :label-width="formLabelWidth" prop="project_id">
			...
			<el-col :span="span">
				<el-form-item :label="labelProjectTitle" :label-width="formLabelWidth" prop="sub_project">
					<el-select v-model="form.sub_project" style="width: 100%;" filterable
						:placeholder="isReadOnly(placeholderTitle)" :disabled="readonly">
						<el-option v-for="data in selectData.costData" :key="data.item_id" :label="data.item_name"
			...
			<el-col :span="span">
				<el-form-item label="日期" :label-width="formLabelWidth" prop="cost_date">
          <el-date-picker v-model="form.cost_date" type="month" :placeholder="isReadOnly('请选择月份')"
      ...
      <el-col :span="span">
          ...
          <el-input v-model="form.amount" :placeholder="isReadOnly('请输入金额')" style="width:100%"
          	:readonly="readonly" maxlength="25">
          </el-input>
      	</el-form-item>
      </el-col>
			<el-col :span="span">
				<el-form-item label="事由" :label-width="formLabelWidth" prop="reason">
          <el-input v-model="form.reason" :placeholder="isReadOnly('请输入事由')" style="width:100%"
          	:readonly="readonly" maxlength="25">
          </el-input>
				</el-form-item>
			</el-col>
      <el-col :span="span">
      	<el-form-item label="是否请示" :label-width="formLabelWidth" prop="isApply">
          <el-input v-model="form.isApply" :placeholder="isReadOnly('请选择是否请示')" style="width:100%"
          	:readonly="readonly" maxlength="25">
          </el-input>
      	</el-form-item>
      </el-col>
      <el-col :span="span">
      	<el-form-item label="有无发票" :label-width="formLabelWidth" prop="hasReceipt">
          <el-input v-model="form.hasReceipt" :placeholder="isReadOnly('请选择有无发票')" style="width:100%"
          	:readonly="readonly" maxlength="25">
          </el-input>
      	</el-form-item>
      </el-col>
      ...
      project_type: {
		...
		data() {
			...
			return {
				...
				formdefalut: {},
				extraIsShow: false,
        labelProjectTitle: '成本项目',
        placeholderTitle: '请选择成本项目...',
				maxHeight: 200,
				selectData: {
					org_type: [],
					parent_id: [],
        ...
        switch (this.project_type) {
        	case 0:
        		this.labelProjectTitle = '成本项目'
        		this.placeholderTitle = '请选择成本项目...'
        		break;
        	case 1:
        ...
        let sData = '[Q]882{'+that.current_org_id+'%}|^SYS'
        let res = await QueryExec(sData)
        console.log(sData,res)
