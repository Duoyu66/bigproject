	...
	export default {
		...
		methods: {
			...
			GetNextStatus() {
				...
				formTemp.processingStatus = that.process.send.label
			...
			async submit() {
				...
				try {
					...
					const {
						...
						influence,
						data
					} = await that.QueryExec_fob(396, list, form)
