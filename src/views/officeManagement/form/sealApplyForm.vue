	...
	<el-form ref="form" :model="form" :rules="rules">
		<el-row>
			<el-col :span="span.full">
				...
				<el-form-item label="印章所在单位" :label-width="formLabelWidth" prop="org_id">
					<tree-select :options="selectData.org_id" :max-height="maxHeight" :multiple="false"
						...
						:disabled="true" v-model="form.org_id" />
				</el-form-item>
			</el-col>
			<el-col :span="span.full" v-if="!sealIsReadonly && !readonly">
				<el-form-item label="" :label-width="formLabelWidth">
					<el-alert :title="sealIs.tips" type="info" :closable="false" center show-icon> </el-alert>
					<!-- 						<el-input v-model="sealIs.tips" style="width:100%" :readonly="true" maxlength="50">
						</el-input> -->
				</el-form-item>
			</el-col>
			<el-col :span="span.full">
				<el-form-item label="印章名称" :label-width="formLabelWidth" prop="seal_id">
					<el-select v-model="form.seal_id" style="width: 100%" filterable default-first-option
						:disabled="sealIsReadonly">
						<el-option v-for="data in selectData.seal_id" :key="data.item_id" :label="data.item_name"
							:value="data.item_id">
						</el-option>
					</el-select>
				</el-form-item>
			...
			<el-col :span="span.full">
				<el-form-item label="申请人" :label-width="formLabelWidth" prop="applicant">
					<el-input v-model="form.applicant" :placeholder="isReadOnly('')" style="width:100%" :readonly="true"
						maxlength="50">
					</el-input>
				</el-form-item>
			</el-col>
			<el-col :span="span.full" v-if="readonly">
				<el-form-item label="申请时间" :label-width="formLabelWidth" prop="apply_date">
					<el-input v-model="form.apply_date" :placeholder="isReadOnly('请输入申请时间')" style="width:100%"
						:readonly="readonly" maxlength="50">
					</el-input>
				</el-form-item>
			</el-col>
			<el-col :span="span.full">
				<el-form-item label="预计使用时间" :label-width="formLabelWidth" prop="expectedTime">
					<el-date-picker v-model="form.expectedTime" align="right" type="datetime"
						:placeholder="isReadOnly('选择预计使用时间')" :picker-options="pickerOptions" style="width: 100%"
		...
		data() {
			...
			return {
				...
				form: {
					...
					applicant: '',
					applicantId: '',
					expectedTime: getdayEx(undefined, undefined, dateFormat(1)),
					memo: '',
					org_id: '',
					apply_date: '',
				},
		...
		methods: {
			...
			async init() {
				...
				if (!this.form.applicant) {
					...
					this.form.applicantId = this.person_id
				}
