	...
	<div>
		<el-form ref="form" :model="queryForm" :inline="true" @submit.native.prevent>
			<el-form-item label="" label-width="0px">
				<el-input v-model="queryForm.project_id" style="width: 100%" placeholder="交易中心工程编号" clearable>
				</el-input>
			</el-form-item>
			<el-form-item>
				<el-input v-model="queryForm.project_name" style="border-radius: 30px,width: 100%" placeholder="交易中心工程名称" clearable>
				</el-input>
			</el-form-item>
			<el-form-item>
				<el-input v-model="queryForm.main_kind" style="border-radius: 30px,width: 100%" placeholder="工程类别" clearable>
				</el-input>
			</el-form-item>
			<!-- <el-form-item>
