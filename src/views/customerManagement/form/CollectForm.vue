...
<!--        <el-form-item label="客户名称" prop="customer_name" :label-width="formLabelWidth" >
        ...
        <el-form-item label="收款时间" prop="pay_time" :label-width="formLabelWidth">
      		<el-date-picker
        ...
        <el-form-item label="收款类型" prop="channel" :label-width="formLabelWidth">
        ...
        <el-form-item label="事由" prop="memo" :label-width="formLabelWidth">
  ...
  import {
	...
	export default {
      ...
      var validate_receipt_cost = (rule, value, callback) => {
        let reg = /^(([1-9][0-9]*)|(([0]\.\d{1,6}|[1-9][0-9]*\.\d{1,6})))$/;
        if (!reg.test(value)) {
