...
<!-- 			<el-col :span="span">
			...
			<el-col :span="span">
				<el-form-item label="校检完成日期" prop="contract_start">
					<el-date-picker
...
<!--          <el-col :span="span">
          ...
          <el-col :span="span">
            <el-form-item label="送检人" prop="operator_people">
...
<!-- 			<el-col :span="24">
			...
			<el-col :span="24">
				<el-form-item label="校检工作内容" prop="work_content">
  ...
  import contractimageupload from '@/components/Upload/upload'
    ...
    computed: {
      ...
      async fetchData() {
        ...
        let sData7 = '[Q]211{'+this.current_org+'$`3}|^SYS'
