...
<!--        <el-form-item label="预计进款(万)" prop="plan_amount" :label-width="formLabelWidth">
       ...
       <el-form-item label="保证进款(万)" prop="protect_amount" :label-width="formLabelWidth">
        	<el-input v-model="form.protect_amount" style="width: 100%;"></el-input>
        </el-form-item>
    ...
    components: {
      ...
      var validate_discount = (rule, value, callback) => {
        ...
        rules: {
          ...
          protect_amount: [{ validator: validate_receipt_cost, trigger: 'blur' },{ required: true, trigger: 'blur', message: '请输入合同金额' }],
        },
