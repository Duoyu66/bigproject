<template>
  <div class="draftPageHigh">
    <el-table ref="branchInstitutions" v-loading="listLoading" :data="tablelist" border
      ...
      <el-table-column show-overflow-tooltip label="计划日期" prop="plan_date" min-width="100px"></el-table-column>
      <el-table-column show-overflow-tooltip label="检校方式" prop="operate_mode" min-width="100px"></el-table-column>
      <el-table-column show-overflow-tooltip label="检校日期" prop="action_date" min-width="100px"></el-table-column>
      <el-table-column show-overflow-tooltip label="检/校结果" prop="conclusion" min-width="180px"></el-table-column>
      <el-table-column show-overflow-tooltip label="检校机构" prop="adjust_agent" min-width="100px"></el-table-column>
      <el-table-column show-overflow-tooltip label="检校记录照片" prop="cert_image" min-width="100px"></el-table-column>
      <el-table-column show-overflow-tooltip label="证书编号" prop="cert_id" min-width="120px"></el-table-column>
      <el-table-column show-overflow-tooltip label="送检/校人员" prop="sender" min-width="100px"></el-table-column>
...
<script>
  ...
  import adjustHistoryDialog from '../component/adjustHistoryDialog'
  export default {
    name: 'adjustHistoryTable',
    components: { adjustHistoryDialog, },
    props: {
    ...
    methods: {
      ...
      async fetchDataMain(pageInfo, treeNode, resolve) {
        ...
        await that.search_fob(select_list, that, 921, {
