<template>
  <div class="draftPageHigh">
    <el-table ref="branchInstitutions" v-loading="listLoading" :data="tablelist" border
      ...
      <el-table-column show-overflow-tooltip label="设备ID" prop="device_id" min-width="120px"></el-table-column>
      <el-table-column show-overflow-tooltip label="设备名称" prop="name" min-width="120px"></el-table-column>
      <el-table-column show-overflow-tooltip label="型号" prop="model" min-width="120px"></el-table-column>
      <el-table-column show-overflow-tooltip label="生产厂家" prop="factory" min-width="150px"></el-table-column>
      <el-table-column show-overflow-tooltip label="生产日期" prop="production_date" min-width="120px"></el-table-column>
      <el-table-column show-overflow-tooltip label="启用日期" prop="buy_date" min-width="120px"></el-table-column>
      <el-table-column show-overflow-tooltip label="校准日期" prop="last_adjust_date" min-width="120px"></el-table-column>
      <el-table-column show-overflow-tooltip label="管理编号" prop="manage_id" min-width="120px"></el-table-column>
      <el-table-column show-overflow-tooltip label="读数范围" prop="show_scope" min-width="120px"></el-table-column>
      <el-table-column show-overflow-tooltip label="读数精度" prop="resolution" min-width="120px"></el-table-column>
      <el-table-column show-overflow-tooltip label="金额" prop="amount" min-width="100px"></el-table-column>
      <el-table-column show-overflow-tooltip label="产品编码" prop="product_no" min-width="120px"></el-table-column>
      <el-table-column show-overflow-tooltip label="证书标识" prop="cert_id" min-width="100px"></el-table-column>
      <el-table-column show-overflow-tooltip label="校检周期" prop="adjust_cycle" min-width="100px"></el-table-column>
      <el-table-column show-overflow-tooltip label="校检结果" prop="adjust_result" min-width="100px"></el-table-column>
      <el-table-column show-overflow-tooltip label="备注" prop="remark" min-width="150px"></el-table-column>
      <el-table-column show-overflow-tooltip label="设备等级" prop="level" min-width="100px"></el-table-column>
      <el-table-column show-overflow-tooltip label="所属试验室" prop="belong_to" min-width="150px"></el-table-column>
      <el-table-column show-overflow-tooltip label="责任人" prop="owner" min-width="100px"></el-table-column>
      <el-table-column show-overflow-tooltip label="购买机构" prop="buy_agent" min-width="150px"></el-table-column>
      <el-table-column show-overflow-tooltip label="维护周期" prop="mt_interval" min-width="100px"></el-table-column>
      <el-table-column show-overflow-tooltip label="上次维护时间" prop="last_mt_date" min-width="150px"></el-table-column>
      <el-table-column show-overflow-tooltip label="规格" prop="specification" min-width="100px"></el-table-column>
...
<script>
  ...
  import deviceLedgerDialog from '../component/deviceLedgerDialog'
  export default {
    name: 'deviceLedgerTable',
    components: { deviceLedgerDialog, },
    props: {
    ...
    methods: {
      ...
      async fetchDataMain(pageInfo, treeNode, resolve) {
        ...
        await that.search_fob(select_list, that, 909, {
