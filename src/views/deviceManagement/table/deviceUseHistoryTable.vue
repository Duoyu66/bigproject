<template> 
  <div class="draftPageHigh"> 
    <el-table ref="branchInstitutions" v-loading="listLoading" :data="tablelist" border 
      ...
      <el-table-column show-overflow-tooltip label="开始时间" prop="start_time" min-width="120px"></el-table-column> 
      <el-table-column show-overflow-tooltip label="结束时间" prop="end_time" min-width="120px"></el-table-column> 
      <el-table-column show-overflow-tooltip label="部门" prop="department" min-width="150px"></el-table-column> 
      <el-table-column show-overflow-tooltip label="领导" prop="leader" min-width="120px"></el-table-column> 
...
<script> 
  ...
  import deviceUseHistoryDialog from '../component/deviceUseHistoryDialog' 
  export default { 
    name: 'deviceUseHistoryTable', 
    components: { deviceUseHistoryDialog, }, 
    props: { 
    ...
    methods: { 
      ...
      async fetchDataMain(pageInfo, treeNode, resolve) { 
        ...
        await that.search_fob(select_list, that, 913, { 
