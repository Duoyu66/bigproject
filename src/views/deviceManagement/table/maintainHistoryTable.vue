<template> 
  <div class="draftPageHigh"> 
    <el-table ref="branchInstitutions" v-loading="listLoading" :data="tablelist" border 
      ...
      <el-table-column show-overflow-tooltip label="负责人" prop="charge_person" min-width="100px"></el-table-column> 
      <el-table-column show-overflow-tooltip label="维护方式" prop="mt_mode" min-width="120px"></el-table-column> 
      <el-table-column show-overflow-tooltip label="维护日期" prop="mt_date" min-width="100px"></el-table-column> 
      <el-table-column show-overflow-tooltip label="维护内容" prop="mt_content" min-width="150px"></el-table-column> 
      <el-table-column show-overflow-tooltip label="结果" prop="result" min-width="120px"></el-table-column> 
      <el-table-column show-overflow-tooltip label="维护公司" prop="mt_agent" min-width="100px"></el-table-column> 
      <el-table-column show-overflow-tooltip label="维护费" prop="mt_fee" min-width="100px"></el-table-column> 
      <el-table-column show-overflow-tooltip label="备注" prop="memo" min-width="120px"></el-table-column> 
...
<script> 
  ...
  import maintainHistoryDialog from '../component/maintainHistoryDialog' 
  export default { 
    name: 'maintainHistoryTable', 
    components: { maintainHistoryDialog, }, 
    props: { 
    ...
    methods: { 
      ...
      async fetchDataMain(pageInfo, treeNode, resolve) { 
        ...
        await that.search_fob(select_list, that, 925, { 
