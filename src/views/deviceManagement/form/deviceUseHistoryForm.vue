    ...
    <el-row> 
      <el-col :span="span"> 
        <el-form-item label="开始时间" :label-width="formLabelWidth" prop="date" > 
          <el-date-picker v-model="form.start_time" align="right" type="date" placeholder="选择日期" style="width: 100%" :format="yyyy-MM-dd" :value-format="yyyy-MM-dd"></el-date-picker> 
        </el-form-item> 
      </el-col> 
      <el-col :span="span"> 
        <el-form-item label="结束时间" :label-width="formLabelWidth" prop="date" > 
          <el-date-picker v-model="form.end_time" align="right" type="date" placeholder="选择日期" style="width: 100%" :format="yyyy-MM-dd" :value-format="yyyy-MM-dd"></el-date-picker> 
        </el-form-item> 
      </el-col> 
      <el-col :span="span"> 
        <el-form-item label="部门" :label-width="formLabelWidth" prop="varchar" > 
          <el-input v-model="form.department" :placeholder="isReadOnly('')" style="width:100%" maxlength="16"></el-input> 
        </el-form-item> 
      </el-col> 
      <el-col :span="span"> 
        <el-form-item label="领导" :label-width="formLabelWidth" prop="varchar" > 
          <el-input v-model="form.leader" :placeholder="isReadOnly('')" style="width:100%" maxlength="16"></el-input> 
        </el-form-item> 
      </el-col> 
    </el-row> 
  </el-form> 
...
<script> 
  ...
  export default { 
    name: 'deviceUseHistoryForm', 
    components: { 
      // deviceUseHistoryForm, 
    }, 
    model: { 
      prop: 'formData', 
      event: 'on-change' 
      ...
      async save(callback) { 
        ...
        async function submit() { 
          ...
          let list = [ 
            ...
            { field: 'start_time', type: 3, level: 4}, 
            { field: 'end_time', type: 3, level: 5}, 
            { field: 'department', type: 3, level: 6}, 
            { field: 'leader', type: 3, level: 7}, 
          ] 
          let fob = ''; 
          let sqlcode = -1; 
          let msg = '' 
