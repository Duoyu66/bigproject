<template>
	<el-form ref="form" :model="form" :rules="rules">
		<el-row>
			<div v-for="(item,index) in selectData.device" :key="item.device_id">
				<el-col :span="span">
					<el-form-item label="分组id" :label-width="formLabelWidth" prop="group_id"
						v-show="form[index].group_id&&parseFloat(form.group_id)>0">
						<el-input v-model="form.group_id" :placeholder="isReadOnly('')" style="width:100%"
