<template> 
  <el-form ref="form" :model="form" :rules="rules"> 
    <el-row> 
      <el-col :span="span"> 
        <el-form-item label="整改方法" :label-width="formLabelWidth" prop="varchar" > 
          <el-input v-model="form.improve_method" :placeholder="isReadOnly('')" style="width:100%" maxlength="undefined"></el-input> 
        </el-form-item> 
      </el-col> 
      <el-col :span="span"> 
        <el-form-item label="整改" :label-width="formLabelWidth" prop="varchar" > 
          <el-input v-model="form.improvement" :placeholder="isReadOnly('')" style="width:100%" maxlength="128"></el-input> 
        </el-form-item> 
      </el-col> 
      <el-col :span="span"> 
        <el-form-item label="整改日期" :label-width="formLabelWidth" prop="datetime" > 
          <el-date-picker v-model="form.improve_date" align="right" type="date" placeholder="选择日期" style="width: 100%" format="yyyy-MM-dd" value-format="yyyy-MM-dd"></el-date-picker> 
        </el-form-item> 
      </el-col> 
      <el-col :span="span"> 
        <el-form-item label="整改结果" :label-width="formLabelWidth" prop="varchar" > 
          <el-input v-model="form.improve_result" :placeholder="isReadOnly('')" style="width:100%" maxlength="128"></el-input> 
        </el-form-item> 
      </el-col> 
      <el-col :span="span"> 
        <el-form-item label="核对日期" :label-width="formLabelWidth" prop="datetime" > 
          <el-date-picker v-model="form.check_date" align="right" type="date" placeholder="选择日期" style="width: 100%" format="yyyy-MM-dd" value-format="yyyy-MM-dd"></el-date-picker> 
        </el-form-item> 
      </el-col> 
    </el-row> 
  </el-form> 
    ...
    methods: { 
      ...
      async save(callback) { 
        ...
        async function submit() { 
          ...
          let list = [ 
            { field: 'improve_method', type: 3, level: 1}, 
            { field: 'improvement', type: 3, level: 2}, 
            { field: 'improve_date', type: 3, level: 3}, 
            { field: 'improve_result', type: 3, level: 4}, 
            { field: 'check_date', type: 3, level: 5}, 
          ] 
          let fob = ''; 
          let sqlcode = -1; 
          let msg = '' 
