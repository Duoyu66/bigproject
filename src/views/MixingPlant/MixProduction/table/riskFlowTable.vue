<template> 
  <div class="draftPageHigh"> 
    <el-table ref="branchInstitutions" v-loading="listLoading" :data="tablelist" border 
      ...
      <el-table-column show-overflow-tooltip label="整改方法" prop="improve_method" min-width="150px"></el-table-column> 
      <el-table-column show-overflow-tooltip label="整改" prop="improvement" min-width="150px"></el-table-column> 
      <el-table-column show-overflow-tooltip label="整改日期" prop="improve_date" min-width="undefined"></el-table-column> 
      <el-table-column show-overflow-tooltip label="整改结果" prop="improve_result" min-width="150px"></el-table-column> 
      <el-table-column show-overflow-tooltip label="核对日期" prop="check_date" min-width="undefined"></el-table-column> 
...
<script> 
  ...
  import riskFlowDialog from '../component/riskFlowDialog' 
  export default { 
    name: 'riskFlowTable', 
    components: { riskFlowDialog, }, 
    props: { 
    ...
    methods: { 
      ...
      async fetchDataMain(pageInfo, treeNode, resolve) { 
        ...
        await that.search_fob(select_list, that, 969, { 
