<template>
	<div class="draftPageHigh">
		<el-table ref="branchInstitutions" v-loading="listLoading" :data="tablelist" border
			...
			<el-table-column show-overflow-tooltip label="材料名称" prop="material_name" min-width="undefined">
			</el-table-column>
			<el-table-column show-overflow-tooltip label="材料类型" prop="material_type" min-width="undefined">
			</el-table-column>
			<el-table-column show-overflow-tooltip label="材料规格" prop="material_spec" min-width="undefined">
			</el-table-column>
			<el-table-column show-overflow-tooltip label="计划用量" prop="theory_dosage" min-width="undefined">
			</el-table-column>
			<el-table-column show-overflow-tooltip label="实际用量" prop="actual_dosage" min-width="undefined">
			</el-table-column>
