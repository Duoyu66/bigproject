<template>
  <div class="draftPageHigh">
    <el-table ref="branchInstitutions" v-loading="listLoading" :data="tablelist" border
      ...
      <el-table-column show-overflow-tooltip label="配方标识" prop="mix_ratio_id" min-width="120px"></el-table-column>
      ...
      <el-table-column show-overflow-tooltip label="里程" prop="mileage" min-width="120px"></el-table-column>
      <el-table-column show-overflow-tooltip label="施工部位" prop="pour_place" min-width="120px"></el-table-column>
      ...
      <el-table-column show-overflow-tooltip label="备注" prop="remark" min-width="120px"></el-table-column>
      <el-table-column show-overflow-tooltip label="偏差程度" prop="deviation" min-width="120px"></el-table-column>
      <el-table-column show-overflow-tooltip label="司机" prop="driver" min-width="120px"></el-table-column>
      <el-table-column show-overflow-tooltip label="卡车车牌" prop="truck_id" min-width="120px"></el-table-column>
      <el-table-column show-overflow-tooltip label="总盘数" prop="total_reel" min-width="120px"></el-table-column>
      ...
      <el-table-column show-overflow-tooltip label="是否合格" prop="first_check_state" min-width="120px"></el-table-column>
      <el-table-column show-overflow-tooltip label="任务单号" prop="task_no" min-width="120px"></el-table-column>
      <el-table-column show-overflow-tooltip label="车标识" prop="car_id" min-width="120px"></el-table-column>
...
<script>
  ...
  import productionReelDialog from '../component/productionReelDialog'
  export default {
    name: 'productionReelTable',
    components: { productionReelDialog, },
    props: {
    ...
    methods: {
      ...
      async fetchDataMain(pageInfo, treeNode, resolve) {
        ...
        await that.search_fob(select_list, that, 986, {
