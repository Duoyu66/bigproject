<template>
	...
	<div>
		<el-table ref="personel" v-loading="listLoading" :data="tablelist" border
			...
			<el-table-column show-overflow-tooltip label="拌合机" prop="device_name" width="100px"></el-table-column>
			<el-table-column v-if="hideColFob('task_no')" show-overflow-tooltip label="任务号" prop="task_no" width="120px"
				align="center">
			</el-table-column>
			<el-table-column v-if="hideColFob('project_name')" show-overflow-tooltip label="工程名称" prop="project_name"
				width="80px" align="center">
			</el-table-column>
			<el-table-column v-if="hideColFob('pour_place')" show-overflow-tooltip label="浇筑部位" prop="pour_place"
				align="center">
			</el-table-column>
			<el-table-column v-if="hideColFob('mileage')" show-overflow-tooltip label="里程" prop="mileage"
				align="center">
			</el-table-column>
			<el-table-column v-if="hideColFob('strength')" show-overflow-tooltip label="强度等级" prop="strength"
				align="center">
			</el-table-column>
			<el-table-column v-if="hideColFob('mix_ratio_id')" show-overflow-tooltip label="配合比号" prop="mix_ratio_id"
				width="80px" align="center">
				<template #default="{ row }">
					<span>{{row.mix_ratio_id}}</span>
				</template>
			</el-table-column>
			<el-table-column v-if="hideColFob('truck_id')" show-overflow-tooltip label="运输车辆" prop="truck_id"
				width="120px" align="center">
				<template #default="{ row }">
					<span>{{row.truck_id}}</span>
				</template>
			</el-table-column>
			<el-table-column v-if="hideColFob('driver')" show-overflow-tooltip label="司机" prop="driver" width="80px"
				align="center">
				<template #default="{ row }">
		...
		<!-- 	<el-table-column v-if="hideColFob('transport_overtime')" show-overflow-tooltip label="运输超时"
				prop="transport_overtime" width="80px" align="center">
				<template #default="{ row }">
					<el-tag v-if="row.transport_overtime&&parseInt(row.transport_overtime)>0" type="danger">√
					</el-tag>
				</template>
			</el-table-column> -->
