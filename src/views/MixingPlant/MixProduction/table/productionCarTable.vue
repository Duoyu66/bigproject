<template>
  <div class="draftPageHigh">
    <el-table ref="branchInstitutions" v-loading="listLoading" :data="tablelist" border
      ...
      <el-table-column show-overflow-tooltip label="机组号" prop="device_id" min-width="120px"></el-table-column>
      <el-table-column show-overflow-tooltip label="任务单号" prop="task_id" min-width="120px"></el-table-column>
      <el-table-column show-overflow-tooltip label="盘号" prop="reel_id" min-width="120px"></el-table-column>
      <el-table-column show-overflow-tooltip label="搅拌时间" prop="duration" min-width="120px"></el-table-column>
      <el-table-column show-overflow-tooltip label="产量" prop="production" min-width="120px"></el-table-column>
      <el-table-column show-overflow-tooltip label="出机时间" prop="output_time" min-width="120px"></el-table-column>
      <el-table-column show-overflow-tooltip label="配方标识
" prop="mix_ratio_id" min-width="120px"></el-table-column>
      ...
      <el-table-column show-overflow-tooltip label="项目名称" prop="project_name" min-width="150px"></el-table-column>
      <el-table-column show-overflow-tooltip label="里程" prop="mileage" min-width="150px"></el-table-column>
      <el-table-column show-overflow-tooltip label="施工部位" prop="pour_place" min-width="150px"></el-table-column>
      <el-table-column show-overflow-tooltip label="保存时间" prop="save_time" min-width="120px"></el-table-column>
      <el-table-column show-overflow-tooltip label="采集时间" prop="sample_time" min-width="120px"></el-table-column>
      <el-table-column show-overflow-tooltip label="客户标识
" prop="client_id" min-width="120px"></el-table-column>
      <el-table-column show-overflow-tooltip label="备注
" prop="remark" min-width="120px"></el-table-column>
      <el-table-column show-overflow-tooltip label="偏差程度" prop="deviation" min-width="120px"></el-table-column>
      <el-table-column show-overflow-tooltip label="司机
" prop="driver" min-width="120px"></el-table-column>
      <el-table-column show-overflow-tooltip label="卡车车牌
" prop="truck_id" min-width="120px"></el-table-column>
      <el-table-column show-overflow-tooltip label="总盘数
" prop="total_reel" min-width="120px"></el-table-column>
      <el-table-column show-overflow-tooltip label="出机温度超标信息" prop="memo" min-width="170px"></el-table-column>
      <el-table-column show-overflow-tooltip label="出机温度" prop="out_temperature" min-width="120px"></el-table-column>
      <el-table-column show-overflow-tooltip label="运输标识" prop="transport_id" min-width="120px"></el-table-column>
      <el-table-column show-overflow-tooltip label="状态" prop="first_check_state" min-width="120px"></el-table-column>
      <el-table-column show-overflow-tooltip label="任务单号
" prop="task_no" min-width="120px"></el-table-column>
      <el-table-column show-overflow-tooltip label="外部生产标识" prop="outer_product_id" min-width="120px"></el-table-column>
      <el-table-column show-overflow-tooltip label="车标识
" prop="car_id" min-width="120px"></el-table-column>
...
<script>
  ...
  import productionCarDialog from '../component/productionCarDialog'
  export default {
    name: 'productionCarTable',
    components: { productionCarDialog, },
    props: {
    ...
    watch: {
      ...
      rowClickData(newVal) {
        if (newVal && newVal.task_no) {
          switch (this.type) {
            case 0:
              this.$emit('update:primary_key', Number(newVal.task_no));
              break;
          }
        }
      },
    ...
    methods: {
      ...
      clearChildren() {
        this.rowClickData = { product_id:-1, }
      },
      fencthRelod(row) {
        if (!row) {
