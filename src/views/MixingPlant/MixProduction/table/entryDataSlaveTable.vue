...
" prop="batch_id" min-width="120px"></el-table-column>
      <el-table-column show-overflow-tooltip label="出厂日期
" prop="output_date" min-width="120px"></el-table-column>
      <el-table-column show-overflow-tooltip label="代表数量" prop="quantity" min-width="120px"></el-table-column>
      <el-table-column show-overflow-tooltip label="强度
" prop="strength" min-width="120px"></el-table-column>
      <el-table-column show-overflow-tooltip label="生产厂家
" prop="factory" min-width="120px"></el-table-column>
      ...
      <el-table-column show-overflow-tooltip label="监理验收日期
" prop="super_check_date" min-width="120px"></el-table-column>
      <el-table-column show-overflow-tooltip label="物料标识" prop="material_id" min-width="120px"></el-table-column>
      <el-table-column show-overflow-tooltip label="合格证" prop="certificate" min-width="120px"></el-table-column>
  ...
  export default {
    ...
    methods: {
      ...
      async fetchDataMain(pageInfo, treeNode, resolve) {
        ...
        await that.search_fob(select_list, that, 1021, {
