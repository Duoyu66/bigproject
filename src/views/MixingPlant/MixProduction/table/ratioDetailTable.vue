<template>
	<div class="draftPageHigh">
		<el-table ref="branchInstitutions" v-loading="listLoading" :data="tablelist" border
			...
			<el-table-column show-overflow-tooltip label="材料名称" prop="material_name" width="120px">
			</el-table-column>
			<el-table-column show-overflow-tooltip label="报告编号" prop="report_id" min-width="150px">
			</el-table-column>
			<el-table-column show-overflow-tooltip label="材料规格" prop="material_spec" width="150px">
			</el-table-column>
			<el-table-column show-overflow-tooltip label="理论用量" prop="theory_dosage" width="80px">
			</el-table-column>
			<el-table-column show-overflow-tooltip label="实际用量" prop="Actual_dosage" width="100px" v-if="type==12">
			</el-table-column>
          	...
          	level: 7
				...
				switch (this.type) {
					...
					case 11:
						...
						break;
          case 12:
          	that.queryForm.proport_id = that.primary_key
          	break;
				}

				await that.search_fob(select_list, that, 977, {
