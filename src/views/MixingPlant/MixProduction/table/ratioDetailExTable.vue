<template>
  <div class="draftPageHigh">
    <el-table ref="branchInstitutions" v-loading="listLoading" :data="tablelist" border
      ...
      <el-table-column show-overflow-tooltip label="材料名称" prop="material_name" min-width="150px"></el-table-column>
      <el-table-column show-overflow-tooltip label="材料规格" prop="matrerial_spec" min-width="150px"></el-table-column>
      <el-table-column show-overflow-tooltip label="报告编号" prop="report_id" min-width="150px"></el-table-column>
      <el-table-column show-overflow-tooltip label="理论用量" prop="theory_dosage" min-width="120px"></el-table-column>
      <el-table-column show-overflow-tooltip label="实际用量" prop="Actual_dosage" min-width="120px"></el-table-column>
      <el-table-column show-overflow-tooltip label="含水率" prop="water_ratio" min-width="120px"></el-table-column>
...
<script>
  ...
  import ratioDetailDialog from '../component/ratioDetailDialog'
  export default {
    name: 'ratioDetailTable',
    components: { ratioDetailDialog, },
    props: {
    ...
    methods: {
      ...
      async fetchDataMain(pageInfo, treeNode, resolve) {
        let that = this
        let select_list = [
          { field: 'proport_id',	type: 3,	level: 1	},
          { field: 'pageNo',	type: 3,	level: 2	},
          { field: 'pageSize',	type: 3,	level: 3	},
        ]
        this.queryForm.proport_id=this.primary_key
        await that.search_fob(select_list, that, 1002, {
