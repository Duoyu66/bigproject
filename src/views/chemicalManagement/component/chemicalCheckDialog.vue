<template>
	<el-dialog :title="title" :visible.sync="dialogFormVisible" top="3vh" destroy-on-close>
		<div style="max-height: calc(100vh - 220px); overflow-y: auto">
			<chemicalCheckForm ref="chemicalCheckForm" :formData="form"></chemicalCheckForm>
		</div>
...
<script>
	...
	import chemicalCheckForm from '../form/chemicalCheckForm.vue'

	export default {
		name: 'chemicalCheckDialog',
		components: {
			chemicalCheckForm,
		},
		data() {
		...
		methods: {
			...
			handleUpdate() {
				let that = this
				this.$refs['chemicalCheckForm'].save(function(status) {
					if (status) {
