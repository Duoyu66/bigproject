	...
	<el-dialog :title="title" :visible.sync="dialogFormVisible">
		<el-form ref="yfdc" :model="form" :rules="rules">
			<el-form-item prop="name" label="化学品名称" :label-width="formLabelWidth">
				<el-input v-model="form.name" autocomplete="off" maxlength="16" style="width: 250px"></el-input>
			</el-form-item>
			<el-form-item label="化学品规格" prop="model" :label-width="formLabelWidth">
				<el-input v-model="form.model" autocomplete="off" maxlength="16" style="width: 250px"></el-input>
			</el-form-item>
				...
				rules: {
					...
					unit: [{
						...
						validator: async function(rule, value, callback) {
							if (value.length > 8) {
								callback(new Error('单位长度请小于8个字符'))
								return
							}
							callback()
						}
