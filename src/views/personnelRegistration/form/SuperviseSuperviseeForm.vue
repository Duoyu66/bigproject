		...
		<el-row class="" style="margin-top: 5px">
			<el-col :span="span" v-show="baseInfoIsShow">
				<el-form-item label="监督内容" :label-width="formLabelWidth" prop="supervision_content">
					<el-input v-model="form.supervision_content" style="width: 100%" type="textarea" maxlength="50"
						:placeholder="isReadOnly('请输入监督内容')" readonly="readonly" show-word-limit :autosize="{ minRows: 4}" ></el-input>
				</el-form-item>
			</el-col>
			<el-col :span="span" v-show="baseInfoIsShow">
			...
			<el-col :span="span" v-show="baseInfoIsShow">
				<el-form-item label="监督时间" :label-width="formLabelWidth" prop="supervision_date">
					<el-date-picker v-model="form.supervision_date" align="left" type="datetime"
			...
			<el-col :span="span" v-show="baseInfoIsShow">
				<el-form-item label="检查附件" :label-width="formLabelWidth">
			...
			<el-col :span="span">
				<el-form-item label="改正说明" :label-width="formLabelWidth" prop="supervisee_content">
					<el-input v-model="form.supervisee_content" style="width: 100%" maxlength="100" type="textarea"
						:placeholder="isReadOnly('请输入改正说明')" :readonly="readonly" show-word-limit :autosize="{ minRows: 4}" ></el-input>
				</el-form-item>
			</el-col>
			<el-col :span="span">
			...
			<el-col :span="span">
				<el-form-item label="改正附件" :label-width="formLabelWidth">
					<supervisionenclosureupload ref="supervisee_enclosure" v-model="form.supervisee_enclosure"
	...
	export default {
		...
		data() {
			...
			return {
				...
				form: {
					supervisee_content: '',
					supervisee_date: getTodayDatetime(),
		...
		watch: {
			formData(newVal, oldVal) {
				...
				this.form.supervisee = this.person_id
				if (this.form.supervisee_date) {
					this.form.supervisee_date = this.form.supervisee_date.substring(0, 18);
				}

				console.log('watch', this.form.supervisee_date)
		...
		methods: {
			...
			file_default() {
				...
				let that = this
				that.upload.original_name.supervisee_enclosure[
					form.supervisee_enclosure
				] = '附件'
