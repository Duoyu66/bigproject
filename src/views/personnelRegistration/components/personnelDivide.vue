	...
	<el-dialog :title="title" :visible.sync="dialogFormVisible" width="500px" @close="close">
		<el-form ref="form" :model="form" :rules="rules">
			<el-form-item label="试验名称" :label-width="formLabelWidth">
				<el-cascader :options="form.options2" :props="{ expandTrigger: 'hover' }" style="width: 300px">
				</el-cascader>
			</el-form-item>
			<el-form-item label="参数名称" :label-width="formLabelWidth" style="margin-top: 10px">
				<el-select v-model="form.form2" style="width: 300px">
					<el-option label="含水率" value="single"></el-option>
				</el-select>
			</el-form-item>
			<el-form-item label="生效日期" :label-width="formLabelWidth" style="margin-top: 10px">
				<el-date-picker v-model="form.add6value1" type="date" placeholder="选择日期" style="width: 300px">
				</el-date-picker>
			</el-form-item>
		</el-form>
