<template>
  <div class="draftPageHigh">
    <el-table ref="branchInstitutions" v-loading="listLoading" :data="tablelist" border
      ...
      <el-table-column show-overflow-tooltip label="开始时间" prop="start_date" min-width="120px"></el-table-column>      <el-table-column show-overflow-tooltip label="结束时间" prop="end_date" min-width="120px"></el-table-column>      <el-table-column show-overflow-tooltip label="学校" prop="school" min-width="150px"></el-table-column>      <el-table-column show-overflow-tooltip label="专业" prop="major" min-width="150px"></el-table-column>      <el-table-column show-overflow-tooltip label="证书编号" prop="cert_id" min-width="150px"></el-table-column>      <el-table-column show-overflow-tooltip label="证书图片" prop="cert_image" min-width="150px"></el-table-column>      <el-table-column show-overflow-tooltip label="操作" width="55px" align="center" fixed="right">
...
<script>
  ...
  import educationHistoryDialog from '../component/educationHistoryDialog'
  export default {
    name: 'educationHistoryTable',
    components: { educationHistoryDialog, },
    props: {
    ...
    methods: {
      ...
      async fetchDataMain(pageInfo, treeNode, resolve) {
        let that = this
        await that.search_fob(select_list, that, undefined, {
