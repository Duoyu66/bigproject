    ...
    <el-row> 
      <el-col :span="span"> 
        <el-form-item label="开始时间" :label-width="formLabelWidth" prop="date" > 
          <el-date-picker v-model="form.start_date" align="right" type="date" placeholder="选择日期" style="width: 100%" :format="yyyy-MM-dd" :value-format="yyyy-MM-dd"></el-date-picker> 
        </el-form-item> 
      </el-col> 
      <el-col :span="span"> 
        <el-form-item label="结束时间" :label-width="formLabelWidth" prop="date" > 
          <el-date-picker v-model="form.end_date" align="right" type="date" placeholder="选择日期" style="width: 100%" :format="yyyy-MM-dd" :value-format="yyyy-MM-dd"></el-date-picker> 
        </el-form-item> 
      </el-col> 
      <el-col :span="span"> 
        <el-form-item label="学校" :label-width="formLabelWidth" prop="varchar" > 
          <el-input v-model="form.school" :placeholder="isReadOnly('')" style="width:100%" maxlength="16"></el-input> 
        </el-form-item> 
      </el-col> 
      <el-col :span="span"> 
        <el-form-item label="专业" :label-width="formLabelWidth" prop="varchar" > 
          <el-input v-model="form.major" :placeholder="isReadOnly('')" style="width:100%" maxlength="16"></el-input> 
        </el-form-item> 
      </el-col> 
      <el-col :span="span"> 
      ...
      <el-col :span="span"> 
        <el-form-item label="证书图片" :label-width="formLabelWidth" prop="varchar" > 
      ...
      async save(callback) { 
        ...
        async function submit() { 
          ...
          let list = [ 
            ...
            { field: 'person_id', type: 3, level: 3}, 
            { field: 'start_date', type: 3, level: 4}, 
            { field: 'end_date', type: 3, level: 5}, 
            { field: 'school', type: 3, level: 6}, 
            { field: 'major', type: 3, level: 7}, 
            { field: 'cert_id', type: 3, level: 8}, 
