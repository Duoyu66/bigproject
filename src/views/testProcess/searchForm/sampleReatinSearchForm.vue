			...
			<el-row class="" style="">
				<el-col :span="span">
					<el-row class="" style="">
						...
						<el-col :span="span2">
							<el-form-item label="" label-width="0px">
								<el-input v-model="queryForm.test_person" style="width: 100%" placeholder="留样人"
									clearable>
								</el-input>
							</el-form-item>
						</el-col>
						<el-col :span="span2*2">
							<el-form-item label="" label-width="0px">
								<el-date-picker v-model="queryForm.keep_time_start" type="date" placeholder="留样时间"
									style="width: 47%" :format='dateFormat' :value-format="dateFormat" clearable>
								</el-date-picker>
								-
								<el-date-picker v-model="queryForm.keep_time_end" type="date" placeholder="留样时间"
									style="width: 47%" :format='dateFormat' :value-format="dateFormat" clearable>
								</el-date-picker>
							</el-form-item>
						</el-col>
						<el-col :span="span2">
							<el-form-item label="" label-width="0px">
								<el-input v-model="queryForm.proc_person" style="width: 100%" placeholder="处置人"
									clearable>
								</el-input>
							</el-form-item>
						</el-col>
						<el-col :span="span2*2">
							<el-form-item label="" label-width="0px">
								<el-date-picker v-model="queryForm.proc_time_start" type="date" placeholder="处置时间"
									style="width: 47%" :format='dateFormat' :value-format="dateFormat" clearable>
								</el-date-picker>
								-
								<el-date-picker v-model="queryForm.proc_time_end" type="date" placeholder="处置时间"
									style="width: 47%" :format='dateFormat' :value-format="dateFormat" clearable>
								</el-date-picker>
							</el-form-item>
						</el-col>
						...
						<el-col :span="span2">
							<el-form-item label="" label-width="0px">
								<el-input v-model="queryForm.checkIn" style="width: 100%" placeholder="收样人" clearable>
								</el-input>
							</el-form-item>
						</el-col>
						<el-col :span="span4">
