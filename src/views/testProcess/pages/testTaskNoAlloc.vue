<template>
	<div class=" purchase equipment_btn calc" style="padding-left: 10px;">
		<testDataNoAllocPage ref="testDataNoAllocPage"  stage="3">
		</testDataNoAllocPage>
	</div>
</template>

<script>
	import testDataNoAllocPage from '../component/testDataNoAllocPage'
	//testDataNoAllocPageHistoryTable
	export default {
		name: 'testTaskNoAlloc',
		components: {
			testDataNoAllocPage
		},
		provide() {
		...
		methods: {
			...
			search_main_fob(data) {
				//search
				this.$refs['testDataNoAllocPageTable'].search(data)
			},
		},
	}
</script>
