            ...
            <template #default="{ row }">
              <el-dropdown trigger="click" placement="left-start">
                ...
                <el-dropdown-menu slot="dropdown" class="more">
                  <el-button @click="handleApply(row)">申请印章</el-button>
                  <el-button @click="handleApprove(row)">审核印章</el-button>
                  <el-button @click="handleEdit(row)">报告详情</el-button>
                  <el-button @click="handleEdit(row)">报告用印</el-button>
                </el-dropdown-menu>
              </el-dropdown>
            </template>
...
<!--      <el-tab-pane label="未打印报告">
    ...
    <reportSeal ref="reportSeal"></reportSeal>
    <reportSealApprove ref="reportSealApprove"></reportSealApprove>
  </div>
</template>
...
<script>
  ...
  import reportSealApprove from '../components/reportSealApprove'
  ...
  export default {
    ...
    methods: {
      ...
      handleAdd() {
        this.$refs['reportSeal'].showEdit()
      },
      handleApply(row) {
        this.$refs['reportSeal'].showEdit(row)
      },
      handleApprove(row) {
        this.$refs['reportSealApprove'].showEdit(row)
      },
      normalizer(node) {
      	return {
      		id: node.object_id,
