<template>
	<div class=" purchase equipment_btn calc">
		<sampleRetainPage ref="sampleRetainPageComplete" v-if="ifShow.all" stage="0">
		</sampleRetainPage>
	</div>
</template>

<script>
	import sampleRetainPage from '../component/sampleRetainPage'
	...
	export default {
		...
		methods: {
			...
			search_main_fob(data) {
				//search
				this.$refs['sampleRetainPageTable'].search(data)
			},
		},
	}
</script>
