<template>
	<div class=" purchase equipment_btn calc">
		<sampleDealPage ref="sampleDealPageComplete" v-if="ifShow.all" stage="0">
		</sampleDealPage>
	</div>
</template>

<script>
	import sampleDealPage from '../component/sampleDealPage'
	...
	export default {
		...
		methods: {
			...
			search_main_fob(data) {
				//search
				this.$refs['sampleDealPageTable'].search(data)
			},
		},
	}
</script>
