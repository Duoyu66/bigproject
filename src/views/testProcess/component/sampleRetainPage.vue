	...
	<div class=" definition purchase equipment_btn calc">
       ...
       <div class="baseBox" style="margin-bottom:10px;">
         <vab-query-form>
			...
			<sampleCollectTable ref="sampleCollectTable" :type="20" status="已检"
				style="height: calc(37vh); min-height: 100px" :select-form.sync="searchData"
				:primary_key.sync="primary_key" :permission="permission" :accepted="accepted" :stage="stage">
			</sampleCollectTable>
