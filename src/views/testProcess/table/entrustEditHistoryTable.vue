<template>
  <div class="draftPageHigh">
    <el-table ref="branchInstitutions" v-loading="listLoading" :data="tablelist" border
      ...
      <el-table-column show-overflow-tooltip label="申请时间" prop="apply_date" min-width="150px"></el-table-column>
      <el-table-column show-overflow-tooltip label="申请人" prop="apply_person" min-width="120px"></el-table-column>
      <el-table-column show-overflow-tooltip label="审批人" prop="approve_person" min-width="120px"></el-table-column>
      <el-table-column show-overflow-tooltip label="审批时间" prop="approve_date" min-width="120px"></el-table-column>
...
<script>
  ...
  export default {
    ...
    props: {
      ...
      primary_key_main: { type: Number, default: 0, },
    ...
    watch: {
      primary_key_main(newVal, oldVal) {
    ...
    methods: {
      ...
      async fetchDataMain(pageInfo, treeNode, resolve) {
        let that = this
        let select_list = [
          { field: 'entrust_id',	type: 3,	level: 1	},
          { field: 'pageNo',	type: 3,	level: 2	},
          { field: 'pageSize',	type: 3,	level: 3	},
        ]
        that.queryForm.entrust_id = that.primary_key_main
        await that.search_fob(select_list, that, 1062, {
