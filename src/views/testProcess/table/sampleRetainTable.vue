<template>
	<div>
		<el-table ref="branchInstitutions" v-loading="listLoading" :data="tablelist" border
			...
			<el-table-column show-overflow-tooltip prop="proc_person" label="处置人" width="170px" align="center">
			</el-table-column>
			<el-table-column show-overflow-tooltip prop="proc_time" label="处置时间" width="100px" align="center">
			</el-table-column>
			<el-table-column show-overflow-tooltip prop="proc_type" label="处置方式" width="80px" align="center">
			</el-table-column>
			<el-table-column show-overflow-tooltip prop="proc_desc" label="处置描述" align="center">
			</el-table-column>
			...
			<el-table-column show-overflow-tooltip prop="test_person" label="留样人" min-width="150px" align="center">
			</el-table-column>
			<el-table-column show-overflow-tooltip prop="keep_time" label="留样时间" width="170px" align="center">
			</el-table-column>
			<el-table-column show-overflow-tooltip prop="location" label="保存位置" align="center" width="170px">
			</el-table-column>
			<el-table-column show-overflow-tooltip prop="quantity" label="留样数量" width="100px" align="center">
			</el-table-column>
			<el-table-column show-overflow-tooltip prop="reserved_day" label="预留时间(天)" min-width="150px" align="center">
			</el-table-column>
	...
	export default {
		...
		methods: {
			...
			async fetchData2() {
				...
				that.search_fob(select_list, that, 463, {
					loading: 'listLoading', //加载画面
					data: 'tablelist', //数据存放位置
					total: 'total', //数据数量，根据该数量分页
					queryForm: 'queryForm', //查询数据表单，请将分页条件也放置在其中
