<template>
  ...
  <div class="table-container definition purchase" style="height: calc(100vh - 160px);">
    <vab-query-form>
      <vab-query-form-left-panel>
        <el-button type="primary" @click="dialogFormVisible = true">
          设备录入
        </el-button>
        <el-dialog title="设备录入" :visible.sync="dialogFormVisible">
          <el-form :model="form">
    ...
    <el-table ref="tableSort" v-loading="listLoading" :data="list" border :element-loading-text="elementLoadingText"
      :height="height" @selection-change="setSelectRows" @sort-change="tableSortChange" :header-cell-style="{background:'#e8f0ff' }"height="calc(80%)" >
      ...
      <el-table-column show-overflow-tooltip prop="title" label="测量范围"></el-table-column>
      <el-table-column show-overflow-tooltip label="精度" prop="author"></el-table-column>
      <el-table-column show-overflow-tooltip label="出厂日期" prop="author"></el-table-column>
      <el-table-column show-overflow-tooltip label="购置日期" prop="author"></el-table-column>
      <el-table-column show-overflow-tooltip prop="title" label="设备类型"></el-table-column>
      <el-table-column show-overflow-tooltip label="所属检测室" prop="author"></el-table-column>
      <el-table-column show-overflow-tooltip prop="title" label="存放状态"></el-table-column>
        ...
        <template #default="{ row }">
              <el-dropdown trigger="click" placement="left-start">
                ...
                <el-dropdown-menu slot="dropdown" class="more" >
                  <el-button >添加事故记录</el-button>
                  <el-button >添加维修记录</el-button>
                  <el-button >添加调拨记录</el-button>
                  <el-button >添加维护保养过程</el-button>
                  <el-button >执行期间核查记录</el-button>
                  <el-button >执行校准</el-button>
                  <el-button >设备封存</el-button>
                  <el-button >设备启封</el-button>
                  <el-button >设备详情</el-button>
                </el-dropdown-menu>
              </el-dropdown>
