  ...
  <div class="table-container definition purchase">
    <vab-query-form>
      <vab-query-form-left-panel>
        ...
        <el-dialog title="设备购入" :visible.sync="dialogFormVisible">
          <el-form :model="form">
            ...
            <el-form-item label="设备规格型号" :label-width="formLabelWidth">
            ...
            <el-form-item label="购置费用" :label-width="formLabelWidth">
              <el-input v-model="form.number" style="width: 250px"></el-input>
            </el-form-item>
          </el-form>
