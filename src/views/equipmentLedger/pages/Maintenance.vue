<template>
  ...
  <div class="table-container definition">
    ...
    <el-table ref="tableSort" v-loading="listLoading" :data="list" border :element-loading-text="elementLoadingText"
      ...
      <el-table-column show-overflow-tooltip label="维护日期" prop="author"></el-table-column>
      <el-table-column show-overflow-tooltip prop="title" label="维护措施"></el-table-column>
      <el-table-column show-overflow-tooltip label="维护效果" prop="author"></el-table-column>
      <el-table-column show-overflow-tooltip label="维护人" prop="author"></el-table-column>
