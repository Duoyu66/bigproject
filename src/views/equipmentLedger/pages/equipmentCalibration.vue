<template>
  ...
  <div class="table-container definition">
    <vab-query-form style="margin-bottom: 3px;" class="verifation">
      ...
      <el-col :span="14">
        <fieldset style="border: 0.01px solid #ddd; min-width: inherit;">
          ...
          <el-table highlight-current-row ref="tableSort" v-loading="listLoading" :data="list" border :header-cell-style="{background:'#e8f0ff' }"
            ...
            <el-table-column show-overflow-tooltip prop="title" label="核查方式" min-width="35%"></el-table-column>
            <el-table-column show-overflow-tooltip label="操作" min-width="30%">
              <template #default="{ row }">
                <el-button type="primary" @click="dialogFormVisible = true">
                  执行核查
                </el-button>
                <el-dialog title="执行校检" :visible.sync="dialogFormVisible">
                  <el-form :model="form">
                    ...
                    <el-form-item label="是否合格" :label-width="formLabelWidth">
                      <el-select v-model="form.region" placeholder="合格" style="width: 250px;">
                        <el-option label="合格" value="qualified"></el-option>
                        <el-option label="不合格" value="unqualified"></el-option>
                      </el-select>
                    </el-form-item>
                    <el-form-item label="校检证书" :label-width="formLabelWidth">
                      <el-input v-model="form.name" autocomplete="off" style="width: 205px; margin-right: 5px;"></el-input>
                      <el-button type="primary" class="normal">上传</el-button>
                    </el-form-item>
