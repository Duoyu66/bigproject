<template>
  ...
  <div class="table-container definition purchase">
    ...
    <el-table ref="tableSort" v-loading="listLoading" :data="list" border :element-loading-text="elementLoadingText"
      ...
      <el-table-column show-overflow-tooltip prop="title" label="核查方式"></el-table-column>
      <el-table-column show-overflow-tooltip label="核查实施人" prop="author"></el-table-column>
      <el-table-column show-overflow-tooltip label="核查结果" prop="author"></el-table-column>
      <el-table-column show-overflow-tooltip label="经手人" prop="author"></el-table-column>
