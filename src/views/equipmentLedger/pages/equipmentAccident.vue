  ...
  <div class="table-container definition">
    <vab-query-form>
      <vab-query-form-left-panel>
        ...
        <el-dialog title="添加事故记录" :visible.sync="dialogFormVisible">
          <el-form :model="form">
    ...
    <el-table ref="tableSort" v-loading="listLoading" :data="list" border :element-loading-text="elementLoadingText"
      ...
      <el-table-column show-overflow-tooltip label="事故时间" prop="author"></el-table-column>
      <el-table-column show-overflow-tooltip prop="title" label="破损情况"></el-table-column>
      <el-table-column show-overflow-tooltip label="原因" prop="author"></el-table-column>
      <el-table-column show-overflow-tooltip label="停工天数" prop="author"></el-table-column>
      <el-table-column show-overflow-tooltip prop="title" label="负责人"></el-table-column>
      <el-table-column show-overflow-tooltip label="事故负责人" prop="author"></el-table-column>
