  ...
  <div class="table-container definition">
    <vab-query-form>
      <vab-query-form-left-panel>
        ...
        <el-dialog title="添加维修记录" :visible.sync="dialogFormVisible">
          <el-form :model="form">
    ...
    <el-table ref="tableSort" v-loading="listLoading" :data="list" border :element-loading-text="elementLoadingText"
      ...
      <el-table-column show-overflow-tooltip label="维修日期" prop="author"></el-table-column>
      <el-table-column show-overflow-tooltip prop="title" label="修理类别"></el-table-column>
      <el-table-column show-overflow-tooltip label="修理主要部分" prop="author"></el-table-column>
      <el-table-column show-overflow-tooltip label="维修方法" prop="author"></el-table-column>
      <el-table-column show-overflow-tooltip prop="title" label="维修后情况"></el-table-column>
      <el-table-column show-overflow-tooltip label="承修单位" prop="author"></el-table-column>
      <el-table-column show-overflow-tooltip prop="title" label="竣工时间"></el-table-column>
