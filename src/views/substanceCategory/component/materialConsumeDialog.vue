<template>
	<el-dialog :title="title" :visible.sync="dialogFormVisible" top="3vh" destroy-on-close>
		<div style="max-height: calc(100vh - 220px); overflow-y: auto">
			<materialConsumeForm ref="materialConsumeForm" :formData="form"></materialConsumeForm>
		</div>
...
<script>
	import materialConsumeForm from '../form/materialConsumeForm.vue'

	export default {
		name: 'materialConsumeDialog',
		components: {
			materialConsumeForm,
		},
		data() {
