<template>
	<div id="sxau_20171611244_yfdc_buy_reg_rec" class="definition purchase equipment_btn calc" name="yfdc_buy_reg_rec">
		...
		<el-tabs v-model="c_name" type="border-card" class="box_center" @tab-click="handleClick">
			<el-tab-pane label="作废" class="buy center" name="form" v-if="permission.materialPurchaseAdd">
				<div
					...
					<div style="width: 100%;">
						<div style="height: 100%">
							<div class="purchasefrom">
								<materiaNullifylForm ref="materiaNullifylForm" :chemicalSelectStatus="false"
				...
				<!-- <div class="usage">
					<div style="max-height: calc(100vh - 250px); overflow-y: auto;margin-top: 30px;">
						<materiaNullifylForm ref="materiaNullifylForm"></materiaNullifylForm>
					</div>
					<div>
			...
			<el-tab-pane label="作废记录" name="table">
				<div>
					<div style="float: right;">
						<el-form ref="form" :model="queryForm" :inline="true" @submit.native.prevent>
							...
							<el-form-item>
								<el-input clearable style="border-radius: 30px;" v-model="queryForm.nullify_person"
									placeholder="作废人" />
							</el-form-item>
				...
				<div style="max-height: calc(70vh); overflow-y: auto;clear: both;">
					<materiaNullifylTable ref="materiaNullifylTable" :permission="permission" type="materialNullify"
...
<script>
	...
	import materiaNullifylForm from '../form/materiaNullifylForm'
	...
	export default {
		...
		methods: {
			...
			handleCllickCancel() {
				this.$refs['materiaNullifylForm'].reset_form()
			},
			handleCllickOk() {
				let that = this
				this.$refs['materiaNullifylForm'].save(function(status) {
					if (status) {
						that.$refs["materiaNullifylForm"].resetForm()
			...
			searchTable() {
				this.$refs['materiaNullifylTable'].search(this.queryForm)
			},
