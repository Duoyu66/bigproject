<template>
  ...
  >
    <el-form ref="form" :model="form" :rules="rules" height="400px">
      <el-form-item label="计划日期" :label-width="formLabelWidth1">
        <el-date-picker
      ...
      <el-form-item label="计划内容" :label-width="formLabelWidth1">
        <el-input v-model="form.title" style="width: 250px"></el-input>
      </el-form-item>
      <el-form-item label="实施日期" :label-width="formLabelWidth1">
        <el-date-picker
          v-model="form.datetime"
          type="date"
          placeholder="选择日期"
      ...
      <el-form-item label="计划人" :label-width="formLabelWidth1">
