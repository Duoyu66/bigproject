  ...
  >
    <el-form ref="form" :model="form" :rules="rules" height="400px">
      ...
      <el-form-item label="消耗数量" :label-width="formLabelWidth">
        <el-input v-model="form.mode" style="width: 250px"></el-input>
      </el-form-item>
      ...
      <el-form-item label="参数名称" :label-width="formLabelWidth">
        <el-input v-model="form.result" style="width: 250px"></el-input>
      </el-form-item>
      <el-form-item label="记录人" :label-width="formLabelWidth">
        <el-input v-model="form.people1" style="width: 250px"></el-input>
      </el-form-item>
      <el-form-item label="记录时间" :label-width="formLabelWidth">
        <el-input v-model="form.time" style="width: 250px"></el-input>
      </el-form-item>
    </el-form>
