<template>
  ...
  >
    <el-form ref="form" :model="form" :rules="rules" height="400px">
      ...
      <el-form-item label="账务库存量" :label-width="formLabelWidth">
        <el-input
          v-model="form.number"
          style="width: 250px"
          :disabled="true"
      ...
      <el-form-item label="输入实际库存" :label-width="formLabelWidth">
        <el-input v-model="form.number" style="width: 250px"></el-input>
      </el-form-item>
      <el-form-item label="盘亏（盈）值" :label-width="formLabelWidth">
        <el-input v-model="form.guarantee" style="width: 250px"></el-input>
      </el-form-item>
    </el-form>
