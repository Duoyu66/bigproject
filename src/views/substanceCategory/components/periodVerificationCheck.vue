<template>
  ...
  >
    <el-form ref="form" :model="form" :rules="rules" height="400px">
      ...
      <el-form-item label="计划制作人" :label-width="formLabelWidth">
        <el-input v-model="form.name" style="width: 250px"></el-input>
      </el-form-item>

      <el-form-item label="核查结果" :label-width="formLabelWidth">
        <el-input v-model="form.name1" style="width: 250px"></el-input>
      </el-form-item>
      <el-form-item label="核查意见" :label-width="formLabelWidth">
        <el-input v-model="form.name2" style="width: 250px"></el-input>
      </el-form-item>
      <el-form-item label="证书编号" :label-width="formLabelWidth">
        <el-input v-model="form.name3" style="width: 250px"></el-input>
      </el-form-item>
