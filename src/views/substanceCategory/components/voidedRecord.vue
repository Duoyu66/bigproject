<template>
  ...
  >
    <el-form ref="form" :model="form" :rules="rules" height="400px">
      ...
      <el-form-item label="作废量" :label-width="formLabelWidth">
        <el-input v-model="form.number" style="width: 250px"></el-input>
      </el-form-item>
      <el-form-item label="采购日期" :label-width="formLabelWidth">
        <el-input v-model="form.time3" style="width: 250px"></el-input>
      </el-form-item>
      <el-form-item label="有效期" :label-width="formLabelWidth">
        <el-input v-model="form.time4" style="width: 250px"></el-input>
      </el-form-item>
      <el-form-item label="作废时间" :label-width="formLabelWidth">
        <el-input v-model="form.time1" style="width: 250px"></el-input>
      </el-form-item>
      <el-form-item label="记录人" :label-width="formLabelWidth">
        <el-input v-model="form.people" style="width: 250px"></el-input>
      </el-form-item>
      <el-form-item label="记录时间" :label-width="formLabelWidth">
        <el-input v-model="form.time2" style="width: 250px"></el-input>
      </el-form-item>
    </el-form>
  ...
  <!-- <el-dialog title="添加期间核查记录" :visible.sync="dialogFormVisible">
    <el-form :model="form">
      ...
      <el-form-item label="备注" class="draft_textarea" :label-width="formLabelWidth" >
