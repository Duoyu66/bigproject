		...
		<el-form ref="purchase_from" :model="form" :rules="rules">
			<el-row>
				...
				<el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
					<el-form-item prop="handler" label="核查人" :label-width="formLabelWidth">
						<el-autocomplete class="inline-input" v-model="form.handler"
							:fetch-suggestions="querySearchPerson" :placeholder="isReadOnly('请输入核查人...')" :maxlength='8'
				...
				<el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
					<el-form-item prop="implementation_date" label="核查日期" :label-width="formLabelWidth">
						<el-date-picker v-model="form.implementation_date" align="left" type="date"
							:placeholder="isReadOnly('请选择核查日期')" :picker-options="pickerOptions.before"
							style="width: 100%" :format='dateFormat' :value-format="dateFormat" :readonly="readonly" :disabled="readonly"> 
						</el-date-picker>
					</el-form-item>
				</el-col>
				<el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
					<el-form-item prop="result" label="核查结果" :label-width="formLabelWidth">
						<el-input v-model="form.result" :placeholder="isReadOnly('请输入核查结果...')" type="text"
							style="width: 100%" :readonly="readonly" :disabled="readonly">
						</el-input>
					</el-form-item>
				</el-col>
				<el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
					<el-form-item prop="result_detailed" label="结果详情" :label-width="formLabelWidth">
						<el-input v-model="form.result_detailed" :placeholder="isReadOnly('请输入结果详情...')" type="textarea"
							show-word-limit style="width: 100%" :readonly="readonly" maxlength='100' :disabled="readonly">
						</el-input>
					</el-form-item>
				</el-col>
				<el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
				...
				<el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
					<el-form-item label="附件" :label-width="formLabelWidth">
						<upload ref="enclosure" :tip_show="upload.tip_show" :upload_type="upload.upload_type.enclosure"
							:original_name="upload.original_name.enclosure" :type_str="upload.type_str"
							:type_array="upload.type_array" :success_status.sync="upload.success.enclosure"
							v-model="form.enclosure" :delte_service="upload.delte_service"
							:old_delete.sync="upload.old_delete.enclosure" :only_show="readonly">
						</upload>
					</el-form-item>
				</el-col>
			</el-row>
		...
		data() {
			...
			return {
				...
				upload: {
					...
					delte_service: false,
					upload_type: {
						enclosure: file_about.upload.enclosure
					},
