<template>
	...
	<div class="permissions-container" style="overflow: auto;">
		<el-container>
			<div class="baseBox" style="margin-right: 10px;">
						...
						<el-form ref="form" :model="queryForm_main" :inline="true" @submit.native.prevent>
							<el-row class="" style="" :gutter="0">
								<el-col :span="14" style="margin-right: 10px;">
									<el-form-item>
										<el-input v-model="queryForm_main.type_name" style="width: 100%;"
											placeholder="类型名称" clearable>
										</el-input>
									</el-form-item>
								</el-col>
								<el-col :span="5">
				...
				<el-aside style="width: 270px">
					<OrgTypeTable ref="OrgTypeTable" :type="2"
			...
			<el-main>
				<div class="baseBox" style="height:100%;margin-right: 10px;">
					<vab-query-form-right-panel style="width: 430px; padding: 0 0px;float: right;"
						v-show="primary_key>0">
                ...
                <el-col :span="4">
                  <el-form-item style="">
					...
					<permissionTable ref="permissionTable" v-if="assembly.permissionTable.show" :type="21"
		...
		<OrgTypeDialog ref="OrgTypeDialog" :is-up-data.sync="main_dialog"></OrgTypeDialog>
		<permissionFrom ref="permissionFrom" :is-up-data.sync="main_dialog"></permissionFrom>
	</div>
</template>

<script>
	import OrgTypeTable from '../table/OrgTypeTable'
	import permissionTable from '../table/permissionTable'

	import OrgTypeDialog from '../DiaLog/OrgTypeDialog'
	...
	export default {
		...
		methods: {
			...
			selectData_main() {
				this.$refs['OrgTypeTable'].search(this.queryForm_main)
			},
			...
			async fetchData_main() {
				let that = this
				this.$nextTick(() => {
					that.$refs['OrgTypeTable'].fetchData()
				})
				// let index = setInterval(function() {
				// 	if (that.$refs['OrgTypeTable']) {
				// 		clearInterval(index)
				// 		that.$refs['OrgTypeTable'].fetchData()
				// 	}
				// })
			...
			handlAddRole() {
				this.$refs['OrgTypeDialog'].showEdit()
			},
