...
<style>
	.vue_data_editor > .box-card {
		margin: 20px;
	}

	.vue_data_editor > .btn-hover {
		padding-left: 6px;
		padding-right: 6px;
	}

	.vue_data_editor > .btn-hover:hover {
		background: #e0e0e0 !important;
	}

	.vue_data_editor > .ace-xcode .ace_gutter {
		border-right: none !important;
		background: #fafafa !important;
	}

	.vue_data_editor >  .ace_content_disable {
		background: #fafafa !important;
	}
</style>
<script>
