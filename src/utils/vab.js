import { loadingText, messageDuration, title,title_abbreviation } from '@/config'
...
const install = (Vue, opts = {}) => {
  ...
  Vue.prototype.$baseTitleAbbr = (() => {
    return title_abbreviation
  })()
  /* 全局加载层 */
  ...
  /* 全局ExcelHeight */
  Vue.prototype.$baseExcelHeight = (formType) => {
    let height = window.innerHeight
    let paddingHeight = 400
    const formHeight = 50
